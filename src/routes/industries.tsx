    ...
    <SiteLayout>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {industries.map((i) => (
            <div key={i.name} className="group rounded-2xl border border-border bg-card p-8 transition-all hover:-translate-y-1 hover:shadow-xl">
              ...
              <h3 className="mt-6 font-display text-2xl text-foreground">{i.name}</h3>
      ...
      <section className="mx-auto max-w-7xl px-5 pb-24 lg:px-8">
        <div className="rounded-3xl bg-primary p-12 text-primary-foreground lg:p-16">
          <div className="grid items-center gap-8 lg:grid-cols-3">
            ...
            <Link to="/contact" className="inline-flex items-center justify-center gap-2 rounded-full bg-primary-foreground px-7 py-4 text-sm font-medium text-primary lg:justify-self-end">
