...
export const Route = createFileRoute("/blog/")({
  ...
  head: () => ({
    meta: [
      { title: "Blog — Packaging stories, scenarios & guides | Moments Packaging Kenya" },
      {
        name: "description",
        content:
          "Real stories, scenarios and how-to guides from the Moments Packaging team in Nairobi. Learn how Kenyan brands use packaging to grow.",
      },
      { property: "og:title", content: "Moments Packaging Blog" },
      {
        property: "og:description",
        content:
          "Educative, explanatory and scenario-based packaging articles for Kenyan SMEs and corporates.",
      },
    ],
  }),
