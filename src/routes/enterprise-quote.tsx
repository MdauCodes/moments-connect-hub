...
export const Route = createFileRoute("/enterprise-quote")({
  head: () => ({
    meta: [
      { title: "Enterprise Quote — Moments Packaging Kenya" },
      {
        name: "description",
        content:
          "Custom pricing, dedicated account management, and priority production for orders above 10,000 units.",
      },
      { property: "og:title", content: "Enterprise Quote — Moments Packaging Kenya" },
      {
        property: "og:description",
        content: "Bulk orders above 10,000 units — get a custom quote within 24 hours.",
      },
    ],
  }),
  component: EnterpriseQuotePage,
});
