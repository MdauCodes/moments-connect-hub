  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy — Moments Packaging Kenya" },
      {
        name: "description",
        content:
          "How Moments Packaging Kenya collects, uses and protects your personal information under the Kenya Data Protection Act, 2019.",
      },
  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-12 sm:py-16 lg:px-8">
      ...
      <div className="prose prose-neutral mt-8 max-w-none text-foreground/90">
        ...
        <p>
          For any privacy matter — including data access, correction or deletion requests — contact
        ...
        <ul>
          <li>
            ...
            <code>/account/forgot-password</code>, <code>/account/reset-password</code>): full name,
            email address, phone number, password (stored hashed), and email verification code.
          </li>
          <li>
          ...
          <li>
            <strong>Checkout</strong> (<code>/checkout</code>): billing name, email, phone, M-Pesa
            number, destination address (county, town, nearest courier office), dispatch details
            (sacco / parcel-service name, Nairobi stage or office), order items and any delivery
            notes.
          </li>
          <li>
          ...
          <li>
            ...
            <code>/enterprise-quote</code>): name, business name, email, phone, message, expected
            volumes and any uploaded artwork files.
          </li>
          <li>
            <strong>Newsletter / insider email prompt</strong>: email address (only if you opt in).
          </li>
          <li>
        ...
        <h2>4. Third parties that receive or process your data</h2>
        <p>
        ...
        <ul>
          <li>
            <strong>Safaricom PLC (M-Pesa)</strong> — to process mobile-money payments. Your M-Pesa
            number and transaction reference are shared with Safaricom.
          </li>
          <li>
          ...
          <li>
            <strong>Email providers</strong> we use to send transactional and (where you opted in)
            marketing email.
          </li>
          <li>
            <strong>Regulators, ODPC and law enforcement</strong> where we are legally required to
            disclose.
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            wishlist, persona selection and a one-time splash flag. Without these the site cannot
            function — they do not require consent.
          </li>
          <li>
          ...
          <li>
            <strong>Analytics:</strong> if and when we enable a privacy-friendly analytics tool, it
            will measure anonymous page views and traffic sources so we can improve the catalogue.
            No analytics scripts are loaded today; we will update this list before any are added.
          </li>
          <li>
            <strong>Marketing:</strong> we do not currently run third-party advertising pixels
            (Meta, Google Ads, TikTok). If we add them, we will request your consent first via a
            cookie banner.
          </li>
        </ul>
        <p>
          You can clear or block cookies in your browser settings, but parts of checkout and your
          account may stop working.
        </p>
        ...
        <h2>9. Your rights under the Data Protection Act, 2019</h2>
        ...
        <ul>
          ...
          <li>Request deletion ("right to be forgotten") where the law allows.</li>
          ...
          <li>
            Lodge a complaint with the <strong>Office of the Data Protection Commissioner (ODPC)</strong>{" "}
            via <a href="https://www.odpc.go.ke" target="_blank" rel="noopener noreferrer">www.odpc.go.ke</a>.
          </li>
        </ul>
        <p>
          ...
          the email or phone on your account). We will respond within 30 days as required by the
          Act.
        </p>

        <h2>10. ODPC registration</h2>
        <p>
        ...
        <p>
          Some of our processors (e.g. cloud hosting and email) may process data on servers outside
          Kenya. Where this happens we rely on contractual safeguards as required by the DPA, 2019.
        </p>

        <h2>13. Changes to this policy</h2>
        <p>
          We may update this policy from time to time. The &ldquo;Last updated&rdquo; date above
          reflects the current version. Material changes will be notified by email or a notice on
          the site.
        </p>
