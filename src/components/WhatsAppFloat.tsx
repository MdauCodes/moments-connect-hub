...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-50 flex min-h-[48px] items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-sm font-medium text-white shadow-lg shadow-black/20 transition-all hover:scale-105 hover:shadow-xl sm:bottom-6 sm:right-6 sm:px-5 sm:py-3.5"
    >
