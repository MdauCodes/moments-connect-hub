import { downloadReceiptPdf, downloadDispatchChecklistPdf, downloadOrdersListPdf, downloadCustomerStatementPdf } from '/dev-server/src/lib/pdf.ts';
// jspdf save uses browser; stub
...
downloadReceiptPdf({
  ...
  paymentMethod:'M-Pesa', paymentStatus:'PAID', receiptNumber:'SLR8K2P9XQ',
...
downloadDispatchChecklistPdf({
  ...
  items:[
    {name:'Kraft mailer box', size:'M', material:'Kraft 350gsm', qty:200, lineTotal:13000},
...
downloadCustomerStatementPdf({
  name:'Achieng Otieno', email:'achieng@example.com', phone:'+254 712 345 678', city:'Nairobi',
  lifetimeValue:184500, ordersCount:7, averageOrderValue:26357,
  firstOrderAt:'2025-08-12', lastOrderAt:'2026-05-19',
}, rows);
console.log('done');
